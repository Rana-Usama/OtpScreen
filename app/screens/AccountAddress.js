...
function AccountAddress(props) {
    return (
        <Screen statusBarColor="#E5E5E5" style={{ flex: 1, justifyContent: 'flex-start', alignItems: "center", backgroundColor: "#E5E5E5" }}>
            ...
            {/* Copy button */}
            <TouchableOpacity activeOpacity={0.7} style={{ marginTop: RFPercentage(3), width: RFPercentage(10), height: RFPercentage(5), borderRadius: RFPercentage(10), backgroundColor: theme.white, alignItems: 'center', justifyContent: 'center' }}>
                <Text style={{ color: theme.black, fontSize: RFPercentage(2.2) }}>
                    Copy
                </Text>
            </TouchableOpacity>
