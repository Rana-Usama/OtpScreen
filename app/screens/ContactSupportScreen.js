...
function ContactSupportScreen(props) {
    ...
    return (
        <Screen statusBarColor="#E5E5E5" style={{ flex: 1, justifyContent: 'flex-start', alignItems: "center" }}>
            <LinearGradient colors={['#F7EFFA', '#FCF8ED']} start={[0.1, 0.3]} end={[1, 0.2]} style={{ width: "100%", flex: 1, justifyContent: 'flex-start', alignItems: "center", }} >
